...
if "google_auth" in st.secrets:
    try:
        ...
        # ดึงข้อมูลสำหรับ Dropdown (ใช้คอลัมน์ A)
...
# --- 6. หน้าสำหรับ Admin & การจัดการข้อมูล ---
    ...
    if not st.session_state.get('logged_in', False):
        ...
        # --- ส่วนจัดการรายชื่อ พร้อมเพิ่มช่อง ที่อยู่, ติดต่อ, E-mail ---
        else:
            ...
            with st.container(border=True):
                ...
                if st.button(f"🚀 บันทึกข้อมูล{label}", type="primary"):
                    if new_name:
                        # บันทึก 4 คอลัมน์ตามลำดับที่กำหนดใน GSheet
            ...
            st.write("---")
            st.write(f"📂 รายชื่อและรายละเอียด{label}ในระบบ:")
            # ดึงข้อมูลมาแสดงเป็นตารางเพื่อให้ดูง่าย
