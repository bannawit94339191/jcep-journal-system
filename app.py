...
# --- 3. ระบบควบคุม Navigation (เรียงลำดับใหม่ตามคำขอ) ---
menu_options = [
    "หน้าสำหรับกรอกข้อมูล", 
    "หน้าสำหรับ Admin", 
    "เพิ่มข้อมูลมหาวิทยาลัย/สถาบัน", 
    "เพิ่มข้อมูลหน่วยงาน/สังกัด"
]
...
# --- 6. หน้าสำหรับกรอกข้อมูล (User Form) ---
if st.session_state.nav_state == "หน้าสำหรับกรอกข้อมูล":
    st.markdown("# 📘 ระบบส่งวารสารสหกิจศึกษาก้าวหน้า")
    st.markdown("#### 📝 ฟอร์มส่งวารสาร")
    st.info("💡 กรณีท่านไม่พบข้อมูลหน่วยงาน/มหาวิทยาลัยในรายการ โปรดเลือกเมนูเพิ่มข้อมูลที่แถบด้านข้าง (Sidebar) เพื่อเพิ่มข้อมูลของท่าน")
...
# --- 8. หน้าเพิ่มข้อมูลมหาวิทยาลัยและหน่วยงาน ---
    ...
    if st.button("⬅️ กลับหน้าสำหรับกรอกข้อมูล"):
        change_page("หน้าสำหรับกรอกข้อมูล")
        st.rerun()
