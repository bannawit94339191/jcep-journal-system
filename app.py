...
if st.session_state.nav_state == "หน้าสำหรับกรอกข้อมูล":
    ...
    with st.container(border=True):
        ...
        # ส่วนเลือกประเภทบทความ และช่องกรอกเพิ่มเติมถ้าเลือก "อื่นๆ"
        ...
        work_link = st.text_input("🔗 ลิงก์ผลงาน (ถ้ามี)") # บรรทัดแนบลิงก์กลับมาแล้ว
        ...
        if st.button("🚀 ส่งข้อมูลวารสาร", type="primary", use_container_width=True):
            if not (f_name and phone and email and up_file and uni):
                ...
                try:
                    ...
                    # บันทึกข้อมูลลง Sheets เรียงตามหัวตาราง A-M ในรูป image_399e27.png
                    sheet.append_row([
...
# --- 8. หน้า Admin และ อื่นๆ (ฟังก์ชันเดิมยังอยู่ครบ) ---
